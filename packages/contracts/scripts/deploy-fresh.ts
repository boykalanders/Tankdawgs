...
/**
 * Deploy a FRESH TankDawgs escrow proxy (voucher model) reusing the existing
 ...
 *   pnpm --filter @tankdawgs/contracts exec hardhat run scripts/deploy-fresh.ts --network sepolia
 *
 ...
 *   web:    NEXT_PUBLIC_TANKDAWGS_ADDRESS=<new proxy>
...
async function main() {
  ...
  console.log(`New TankDawgs proxy → ${addr}`);
  ...
  console.log(`  web:    NEXT_PUBLIC_TANKDAWGS_ADDRESS=${addr}`);
