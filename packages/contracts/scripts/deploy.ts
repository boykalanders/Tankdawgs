 ...
 * a fresh TankDawgsNFT (the mintable membership pass) is deployed here too.
 *
...
async function main() {
  ...
  console.log("TankDawgsNFT deployed to:", await nft.getAddress());
  ...
  console.log("TankDawgs proxy deployed to:", await proxy.getAddress());
  console.log(
    "Implementation:",
