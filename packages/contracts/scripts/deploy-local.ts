 ...
 *   • TankDawgsNFT         — mintable membership pass (the play gate)
 *   • MockDDawgsNFT        — stands in for the ChessDawgs NFT (grandfather)
 *   • TankDawgs proxy      — owned by account #0 (= relayer)
...
async function main() {
  ...
  console.log("TankDawgs (proxy):", deployment.poolDawgs);
  console.log("TankDawgsNFT:      ", deployment.poolDawgsNFT);
