...
/// @title TankDawgsNFT — the membership pass that gates TankDawgs play.
/// @notice Free public mint, one per wallet. Holding this (or a ChessDawgs
///         NFT — the grandfather exception, checked by TankDawgs.sol) lets a
...
contract TankDawgsNFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Tank Dawgs", "TDAWG") Ownable(msg.sender) {
    ...
    ///         "https://backend.example.io/v1/nft/tankdawgs/".
